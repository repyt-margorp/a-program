...
- generated function-graph IADTs and certified runners for recording accepted
  ...
  synthesize types;
- artifact v85, namespace-qualified interfaces, relocation, linking,
...
Artifact format v85 serializes the dense reachable accepted or explicitly
...
[`src/prototype/spec/artifact_v85.schema`](src/prototype/spec/artifact_v85.schema).
