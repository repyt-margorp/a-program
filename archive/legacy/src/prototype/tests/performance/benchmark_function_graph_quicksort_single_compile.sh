...
while [ "$run" -le 3 ]; do
	...
	grep '^A_PROGRAM_\(PERFORMANCE\|SOLVER\|SOLVER_KIND\|CONTEXT_RESOLUTION\|CONSTRUCTOR_SPECIALIZATION\|COMPILE_PHASE\|FUNCTION_GRAPH_PHASE\|PROOF_MATERIALIZATION\|ACCEPTED_REPLAY\)_COUNTERS 1 ' \
		"$metrics"
