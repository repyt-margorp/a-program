...
/* APGOCC5 transports descriptive typed inputs, not evidence. Contexts, Core,
 ...
 * and typed images. Earlier input images are rejected.
 ...
 * selected maps in this section, and each nested section independently. Failed reads publish no
