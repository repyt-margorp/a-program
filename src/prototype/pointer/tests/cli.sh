...
check 0 'done steps=' 'main:=#int_to_text (#int_add #20 #22);'
check 1 'rejected steps=' 'main:=#int_to_text #"wrong";'
check 1 'rejected steps=' 'main:=#int64_to_text #1;'
check 1 'rejected steps=' 'format:=#int_to_text; format::#Int->#Int;'
check 1 'rejected steps=' 'main:=#int_to_text #42; main::#Int;'
