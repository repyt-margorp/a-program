...
for writer in retained-write-typed retained-write; do
	for fixture in lambda family append index-alias function-field nominal nullary application constructor specialized-constructor match computed-match fold; do
