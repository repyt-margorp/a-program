...
src/artifact/         interface publication, v83 wire format, relocation, link
...
- `include/a_program/artifact/`, `src/artifact/`: artifact interface,
  publication closure, v83 wire reader/writer, relocation, and linking.
...
`A_PROGRAM_ARTIFACT 83 <calculus-fingerprint>`. The reader accepts that version
...
boundary are specified by `spec/artifact_v83.schema`; the implemented
...
v83 debug/name records are readable, that term exports keep distinct classifier
