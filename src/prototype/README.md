...
src/artifact/         interface publication, v81 wire format, relocation, link
...
- `include/a_program/artifact/`, `src/artifact/`: artifact interface,
  publication closure, v81 wire reader/writer, relocation, and linking.
...
`A_PROGRAM_ARTIFACT 81 <calculus-fingerprint>`. The reader accepts that version
...
boundary are specified by `spec/artifact_v81.schema`; the implemented
...
v81 debug/name records are readable, that term exports keep distinct classifier
