...
src/artifact/         interface publication, v77 wire format, relocation, link
...
- `include/a_program/artifact/`, `src/artifact/`: artifact interface,
  publication closure, v77 wire reader/writer, relocation, and linking.
...
`A_PROGRAM_ARTIFACT 77 <calculus-fingerprint>`. The reader accepts that version
...
boundary are specified by `spec/artifact_v77.schema`; the implemented
...
v77 debug/name records are readable, that term exports keep distinct classifier
